      ...
      <section className="py-16">
        <div className="mx-auto max-w-7xl px-6">
          ...
          <div className="mb-8">
            ...
            <div className="grid grid-cols-[repeat(auto-fill,minmax(260px,1fr))] gap-6 max-md:grid-cols-1">
              {bazar.auctions.map((item, i) => (
                <div className="bg-white rounded-card overflow-hidden shadow-card-hover transition-all duration-300 hover:-translate-y-1 hover:shadow-card-lg border-t-4 border-transparent" key={i} style={{ borderTopColor: item.color }}>
                  <div className="h-20 flex items-end p-3" style={{ background: item.color }}>
                    <span className="bg-white/90 py-1 px-3 rounded-card-sm text-[0.8rem] font-semibold text-secondary">{t.nav.gallery}</span>
                  </div>
                  <div className="p-5">
          ...
          <div className="bg-gradient-to-br from-primary to-primary-dark text-white rounded-card p-10 text-center mb-8">
            ...
            <div className="inline-block bg-white/20 py-2 px-6 rounded-full font-semibold text-[1.1rem]">{bazar.liveAuction.schedule}</div>
          </div>

          <div className="bg-off-white rounded-card p-10 text-center border-2 border-dashed border-gray-300">
