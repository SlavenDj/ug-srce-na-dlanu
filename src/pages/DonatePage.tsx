      ...
      <section className="py-16">
        <div className="mx-auto max-w-7xl px-6">
          <div className="grid grid-cols-[repeat(auto-fill,minmax(340px,1fr))] gap-6 max-md:grid-cols-1">
            <div className="bg-white rounded-card p-8 shadow-card-hover border-t-4 border-primary">
              ...
              <ul className="list-none flex flex-wrap gap-2">
                {donate.online.methods.map((m, i) => (
                  <li key={i} className="bg-gray-100 py-1.5 px-3 rounded-card-sm text-[0.9rem] text-secondary">{m}</li>
                ))}
              </ul>
            </div>
            ...
            <div className="bg-white rounded-card p-8 shadow-card-hover border-t-4 border-primary">
              ...
              <div className="flex flex-col gap-2">
                <div className="text-[0.9rem] leading-[1.5]">
                  <strong>IBAN:</strong> <code className="bg-gray-100 py-0.5 px-1.5 rounded text-[0.85rem] break-all">{donate.foreign.iban}</code>
                </div>
                <div className="text-[0.9rem] leading-[1.5]">
                  <strong>SWIFT:</strong> <code className="bg-gray-100 py-0.5 px-1.5 rounded text-[0.85rem] break-all">{donate.foreign.swift}</code>
                </div>
                <div className="text-[0.9rem] leading-[1.5]">
            ...
            <div className="bg-white rounded-card p-8 shadow-card-hover border-t-4 border-primary">
              ...
              <div className="flex flex-col gap-2">
                <div className="text-[0.9rem] leading-[1.5]">
                  <strong>{t.contactForm.subject}:</strong> <code className="bg-gray-100 py-0.5 px-1.5 rounded text-[0.85rem] break-all">{donate.domestic.accountNumber}</code>
                </div>
                <div className="text-[0.9rem] leading-[1.5]">
            ...
            <div className="bg-white rounded-card p-8 shadow-card-hover border-t-4 border-primary">
              ...
              <ul className="list-none flex flex-wrap gap-2">
                {donate.goods.items.map((item, i) => (
                  <li key={i} className="bg-gray-100 py-1.5 px-3 rounded-card-sm text-[0.9rem] text-secondary">{item}</li>
                ))}
              </ul>
            </div>
