        ...
        <div className="mx-auto max-w-7xl px-6">
          ...
          <div className="grid grid-cols-[repeat(auto-fill,minmax(320px,1fr))] gap-6 max-md:grid-cols-1">
            {news.announcements.map((item, i) => (
              <div className="bg-white rounded-card p-6 shadow-card-hover transition-all duration-300 hover:-translate-y-1 hover:shadow-card-lg" key={i}>
                ...
                <p className="text-gray-700 text-[0.9rem] leading-[1.5]">{item.excerpt}</p>
              </div>
            ))}
          </div>
        </div>
