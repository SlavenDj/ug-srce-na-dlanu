...
export default function News() {
  ...
  return (
    <section id="news" className="py-25 bg-white dark:bg-[#0f1117]">
      <div className="mx-auto max-w-7xl px-6">
        ...
        <div className="grid grid-cols-[repeat(auto-fit,minmax(300px,1fr))] gap-7 max-md:grid-cols-1">
          {news.items.map((item, i) => (
            <div className="bg-white dark:bg-[#171923] border border-gray-200 dark:border-[#2a2d3a] rounded-card overflow-hidden transition-all duration-300 hover:shadow-card-hover hover:-translate-y-1" key={i}>
