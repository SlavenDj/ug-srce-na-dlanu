    ...
    <section className="py-25 bg-off-white">
      <div className="mx-auto max-w-7xl px-6">
        ...
        <div className="relative max-w-[900px] mx-auto py-5">
          <div className="absolute left-1/2 top-0 bottom-0 w-[3px] bg-gray-200 dark:bg-[#2a2d3a] -translate-x-1/2 max-md:left-5" />
          {timeline.map((item, i) => (
            <div
            ...
            >
              ...
              <div className="bg-white dark:bg-[#171923] p-6 rounded-card shadow-card border border-gray-200 dark:border-[#2a2d3a]">
