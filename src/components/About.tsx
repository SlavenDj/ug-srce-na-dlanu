...
export default function About() {
  ...
  return (
    <section id="about" className="py-25 bg-white dark:bg-[#0f1117]">
      <div className="mx-auto max-w-7xl px-6">
        ...
        <div className="grid grid-cols-[1.2fr_0.8fr] gap-15 items-center max-md:grid-cols-1 max-md:gap-10">
          <div>
            <p className="text-[1.05rem] text-gray-700 dark:text-[#d1d5db] leading-[1.8]">{t.about.description}</p>
            <div className="mt-8 p-6 bg-off-white rounded-card border-l-4 border-primary">
              ...
              <p className="text-gray-700 dark:text-[#d1d5db] text-[0.95rem]">{t.about.missionText}</p>
            </div>
            <div className="mt-4 p-6 bg-off-white rounded-card border-l-4 border-accent">
              ...
              <p className="text-gray-700 dark:text-[#d1d5db] text-[0.95rem]">{t.about.visionText}</p>
            </div>
            <div className="mt-8">
              ...
              <ul className="list-none grid grid-cols-2 gap-2 max-md:grid-cols-1">
                {t.about.values.map((v, i) => (
                  <li key={i} className="flex items-center gap-2 text-[0.9rem] text-gray-700 dark:text-[#d1d5db]">
