    ...
    <section className="py-25 bg-off-white">
      <div className="mx-auto max-w-7xl px-6">
        ...
        <div className="max-w-[700px] mx-auto mb-15 text-center">
          <p className="text-[1.2rem] italic text-gray-700 leading-[1.8] mb-3">"{goals.quote}"</p>
        ...
        <div className="grid grid-cols-[repeat(auto-fit,minmax(260px,1fr))] gap-6 mb-15">
          {goals.cards.map((card, i) => (
            <div className="bg-white p-8 rounded-card shadow-card text-center transition-all duration-300 hover:-translate-y-1.5 hover:shadow-card-lg" key={i}>
        ...
        <div className="max-w-[700px] mx-auto">
          ...
          <div className="bg-white p-6 rounded-card shadow-card">
            <div className="flex justify-between mb-3 text-[0.9rem] font-medium text-gray-700">
              <span>{goals.raised}: KM 1.000,00</span>
              <span>{goals.goal}: KM 10.000,00 КМ</span>
            </div>
            <div className="h-3 bg-gray-200 rounded-[6px] overflow-hidden">
              <div
